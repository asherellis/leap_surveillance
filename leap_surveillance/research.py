...
- Match the version. When the metric comes from a benchmark, dataset, index, or methodology that has versions or revisions, use exactly the version the resolution criteria specify - or the version in use as of the target date - not a newer or harder one. State which version you used.
